...
Asena.addCommand({pattern: 'beniat$', fromMe: true, desc: Lang.KICKME_DESC, onlyGroup: true}, (async (message, match) => {
...
Asena.addCommand({pattern: 'ppyap$', fromMe: true, desc: Lang.PP_DESC}, (async (message, match) => {    
